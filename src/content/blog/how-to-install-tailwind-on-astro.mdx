...
title: 'Streamline Your Workflow: Install Tailwind CSS in Your Astro Project'
desc: 'Want to leverage the power of Tailwind CSS for utility-first styling within your Astro project? This guide makes it easy! We walk you through both the automated and manual installation methods, getting you set up in minutes.'
category: 'Tutorial'
